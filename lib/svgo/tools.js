...
import { getNumCollectStyleSheetCalls } from '../style.js';
import { getNumVisitCalls } from '../xast.js';
...
export const showStats = () => {
  console.info(
    `Number of collectStyleSheet() calls: ${getNumCollectStyleSheetCalls()}`,
  );
  console.info(`Number of visit() calls: ${getNumVisitCalls()}`);
};
